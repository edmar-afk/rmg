...
function UnregisteredUsersCard({ isPage }) {
	const customers = [
		{
			id: "0",
			name: "John Doe",
	...
	return (
		<div className="w-full bg-white dark:bg-gray-800 shadow-xs rounded-xl">
			<header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex flex-row items-center justify-between">
				<h2 className="font-semibold text-gray-800 dark:text-gray-100">Lists of Unregistered Users</h2>
...
export default UnregisteredUsersCard;
